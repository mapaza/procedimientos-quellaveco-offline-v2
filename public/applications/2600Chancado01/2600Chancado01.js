...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__2600Chancado01.gltf'.replace('__URL__', '');
    if (!sceneURL) {
...
function prepareExternalInterface(app) {
    ...
    app.ExternalInterface.emitirEstadoAnimacion = function () {
        ...
        // console.log(input, "emitirEstadoAnimacion");
        input.dispatchEvent(new Event("input"));
      };
  
      app.ExternalInterface.emitirEstadoEquipo = function () {
        var input = window.parent.document.querySelector("#estado_equipo");
        // console.log(input, "emitirEstadoEquipo");
        input.dispatchEvent(new Event("input"));
      };
