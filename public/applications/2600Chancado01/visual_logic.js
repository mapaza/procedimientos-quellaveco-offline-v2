...
_initGlob.output.initOptions.preloaderEndCb = function() {
  ...
  setHTMLElemStyle('display', 'none', 'cam-supresor-polvo', true);
  setHTMLElemStyle('display', 'none', 'cam-faja-overland', true);
  setHTMLElemStyle('display', 'none', 'cam-faja-overland-2', true);
  setHTMLElemStyle('display', 'none', 'cam-colector-polvo', true);
  ...
  setHTMLElemStyle('display', 'flex', 'btn_empezar_recorrido_2', true);
...
var percentage, idScene, operadores_visibles, information_id, actions, active_cam, cam_id, operador, objeto_riesgo_mostrar, isChangeScene;
...
function mostrarSubAreas() {
  ...
  setHTMLElemStyle('display', 'flex', 'go-home', true);
  setHTMLElemStyle('display', 'flex', 'go-area', true);
  setHTMLElemStyle('display', 'flex', 'cam-pica-rocas', true);
  setHTMLElemStyle('display', 'flex', 'cam-fajas-alimentadoras', true);
  setHTMLElemStyle('display', 'flex', 'cam-fajas-sacrificio', true);
  setHTMLElemStyle('display', 'flex', 'cam-supresor-polvo', true);
  setHTMLElemStyle('display', 'flex', 'cam-faja-overland', true);
  setHTMLElemStyle('display', 'flex', 'cam-faja-overland-2', true);
  setHTMLElemStyle('display', 'flex', 'cam-colector-polvo', true);
  setHTMLElemStyle('display', 'flex', 'cam-rompe-rocas', true);
  setHTMLElemStyle('display', 'flex', 'cam-tolva-recepcion', true);
}
...
function setUserPosition(active_cam, cam_id, operador, objeto_riesgo_mostrar) {
  if (cam_id != false) {
    ...
    setActiveCamera(active_cam);
    tweenCamera(active_cam, operador, 2, function() {
      setActiveCamera(active_cam);
      changeVis(objeto_riesgo_mostrar, true);
...
function goBack() {
  if (isChangeScene == true) {
    ...
    setActiveCamera('camara_paneo');
    tweenCamera('operador_paneo', '2600_chancado_pica_rocas', 2, function() {
...
eventHTMLElem('click', 'btn_mute_audio', false, function(event) {
  ...
  soundVideoMute(loadMedia_HTML5('../audios/area-2000.mp3'));
});
eventHTMLElem('click', 'btn_unmute_audio', false, function(event) {
  ...
  soundVideoUnmute(loadMedia_HTML5('../audios/area-2000.mp3'));
});
eventHTMLElem('click', 'btn_empezar_recorrido_2', true, function(event) {
  ...
  tweenCamera('Camara002', 'CamaraDireccion002', 8, function() {}, 0);
  registerSetTimeout(1.5, function() {
    playSound(loadMedia_HTML5('../audios/area-2000.mp3'), false);
    registerSetTimeout(8, function() {
      tweenCamera('Camara002', 'CamaraDireccion002', 1, function() {}, 0);
      registerSetTimeout(4, function() {
        tweenCamera('Camara003', 'CamaraDireccion003', 1, function() {}, 0);
        registerSetTimeout(9, function() {
          tweenCamera('Camara004', 'CamaraDireccion004', 6, function() {}, 0);
        });
      });
    });
    registerSetTimeout(31, function() {
      mostrarSubAreas();
...
eventHTMLElem('click', 'cam-pica-rocas', true, function(event) {
  setUserPosition('CamaraChancadora', false, 'CamaraDireccionChancadora', 'Icono001.001');
});
eventHTMLElem('click', 'cam-fajas-alimentadoras', true, function(event) {
  setUserPosition('CamaraChute', false, 'CamaraDireccionChute', 'Icono001.006');
});
eventHTMLElem('click', 'cam-fajas-sacrificio', true, function(event) {
  setUserPosition('CamaraSacrificio', false, 'CamaraDireccionSacrificio', 'Icono001.005');
});
eventHTMLElem('click', 'cam-rompe-rocas', true, function(event) {
  setUserPosition('CamaraRompeRocas', false, 'CamaraDireccionRompeRocas', 'Icono001.003');
});
eventHTMLElem('click', 'cam-tolva-recepcion', true, function(event) {
  setUserPosition('CamaraTolva', false, 'CamaraDireccionTolva', 'Icono001.002');
});
eventHTMLElem('click', 'cam-faja-overland', true, function(event) {
  setUserPosition('CamaraOverland', false, 'CamaraDireccionOverland', 'Icono001.004');
});
...
registerOnClick('ubicacion_op_overland_1', false, false, [0,1,2], function() {
  setUserPosition('camara_operador_overland_1', 'operador-faja-overland', null, null);
  changeVis('ubicacion_op_overland_1', false);
}, function() {});
registerOnClick('ubicacion_op_overland_2', false, false, [0,1,2], function() {
  setUserPosition('camara_operador_overland_2', 'operador-faja-overland-2', null, null);
...
registerOnClick('operador_colector_de_polvo', false, false, [0,1,2], function() {
  setUserPosition('camara_colector_de_polvo', 'operador-colector-polvo', 'operador_colector_de_polvo', null);
}, function() {});
registerOnClick('operador_fajas_alimentadoras', false, false, [0,1,2], function() {
  setUserPosition('camara_alimentadores', 'operador-fajas-alimentadoras', 'operador_fajas_alimentadoras', null);
}, function() {});
registerOnClick('operador_faja_de_sacrificio', false, false, [0,1,2], function() {
  setUserPosition('camara_faja_de_sacrificio', 'operador-faja-sacrificio', 'operador_faja_de_sacrificio', null);
}, function() {});
registerOnClick('operador_pica_roca', false, false, [0,1,2], function() {
  setUserPosition('camara_pica_rocas', 'operador-pica-roca', 'operador_pica_roca', null);
}, function() {});
registerOnClick('operador_supresor_de_polvo', false, false, [0,1,2], function() {
  setUserPosition('Camara_supresor_de_polvo', 'operador-supresor-polvo', 'operador_supresor_de_polvo', null);
}, function() {});
