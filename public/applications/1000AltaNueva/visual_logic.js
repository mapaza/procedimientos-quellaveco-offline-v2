...
_initGlob.output.initOptions.preloaderEndCb = function() {
  ...
  setHTMLElemStyle('display', 'flex', 'btn_empezar_recorrido_1', true);
...
var operadores_visibles, information_id, active_cam, cam_id, operador, objeto_riesgo_mostrar, selected;
...
function ocultarSubAreas() {
  registerSetTimeout(0.00005, function() {
    setHTMLElemStyle('display', 'none', 'cam-presa-vizcachas', true);
    setHTMLElemStyle('display', 'none', 'cam-titire', true);
    setHTMLElemStyle('display', 'none', 'cam-poza', true);
    setHTMLElemStyle('display', 'none', 'go-home', true);
    setHTMLElemStyle('display', 'none', 'go-area', true);
    setHTMLElemStyle('display', 'none', 'controles-container', true);
  });
...
function mostrarSubAreas() {
  setHTMLElemStyle('display', 'flex', 'cam-presa-vizcachas', true);
  setHTMLElemStyle('display', 'flex', 'cam-titire', true);
  setHTMLElemStyle('display', 'flex', 'cam-poza', true);
  setHTMLElemStyle('display', 'flex', 'go-home', true);
  setHTMLElemStyle('display', 'flex', 'go-area', true);
  setHTMLElemStyle('display', 'flex', 'controles-container', true);
}
...
function setInformacion(information_id) {
  console.log('apretando boton verde 1');
...
// Describe this function...
function goBack() {
  tweenCamera('Camara006', 'CamaraDireccion006', 2, function() {
...
if (featureAvailable('MOBILE') == true) {
  ...
  registerOnClick('Icono001', false, false, [0,1,2], function() {
  ...
  setHTMLElemStyle('display', 'none', 'horizontalContainer', true);
  registerOnClick('Icono001.001', false, false, [0,1,2], function() {
    setHTMLElemStyle('display', 'flex', 'riesgo_bocatoma_titire', false);
    ocultar_controles_botones();
  }, function() {});
  eventHTMLElem('click', 'riesgo_bocatoma_titire_cerrar', false, function(event) {
    setHTMLElemStyle('display', 'none', 'riesgo_bocatoma_titire', false);
    mostrar_controles_botones();
  });
  registerOnClick('Icono001', false, false, [0,1,2], function() {
    setHTMLElemStyle('display', 'flex', 'riesgo_presa_vizcacha', false);
    ocultar_controles_botones();
  }, function() {});
  eventHTMLElem('click', 'riesgo_presa_vizcacha_cerrar', false, function(event) {
    setHTMLElemStyle('display', 'none', 'riesgo_presa_vizcacha', false);
    mostrar_controles_botones();
  });
}
...
eventHTMLElem('click', 'btn_mute_audio', false, function(event) {
  ...
  soundVideoMute(loadMedia_HTML5('../audios/area-1000-parte-a.mp3'));
  soundVideoMute(loadMedia_HTML5('../audios/area-1000-parte-b.mp3'));
});
eventHTMLElem('click', 'btn_unmute_audio', false, function(event) {
  ...
  soundVideoUnmute(loadMedia_HTML5('../audios/area-1000-parte-a.mp3'));
  soundVideoUnmute(loadMedia_HTML5('../audios/area-1000-parte-b.mp3'));
});
eventHTMLElem('click', 'btn_empezar_recorrido_1', true, function(event) {
  setHTMLElemStyle('display', 'none', 'btn_empezar_recorrido_1', true);
  setHTMLElemStyle('display', 'flex', 'btn_mute_audio', false);
  setHTMLElemStyle('display', 'flex', 'invisibleContainer', false);
  soundVideoUnmute(loadMedia_HTML5('../audios/area-1000-parte-a.mp3'));
  soundVideoUnmute(loadMedia_HTML5('../audios/area-1000-parte-b.mp3'));
  tweenCamera('Camara001', 'CamaraDireccion001', 8, function() {
    registerSetTimer('myTimer', 0, function() {
      playSound(loadMedia_HTML5('../audios/area-1000-parte-a.mp3'), false);
      registerSetTimer('myTimer3', 2, function() {
        tweenCamera('Camara002', 'CamaraDireccion002', 1, function() {}, 0);
        registerSetTimer('myTimer4', 7, function() {
          tweenCamera('Camara003', 'CamaraDireccion003', 5, function() {}, 0);
          registerSetTimer('myTimer5', 5, function() {
            playSound(loadMedia_HTML5('../audios/area-1000-parte-b.mp3'), false);
            registerSetTimer('myTimer6', 3, function() {
              tweenCamera('Camara004', 'CamaraDireccion004', 1, function() {}, 1);
              registerSetTimer('myTimer7', 6, function() {
                tweenCamera('Camara005', 'CamaraDireccion005', 2, function() {}, 0);
                registerSetTimer('myTimer8', 4, function() {
                  tweenCamera('Camara006', 'CamaraDireccion006', 2, function() {}, 0);
                }, 1);
              }, 1);
            }, 1);
            registerSetTimer('myTimer2', 20, function() {
              mostrarSubAreas();
...
registerOnHover('Icono001', false, function() {
...
tweenCamera('Camara001', 'CamaraDireccion001', 0.0001, function() {}, 0);
ocultarSubAreas();
...
eventHTMLElem('click', 'cam-presa-vizcachas', true, function(event) {
  setUserPosition('CamaraDireccionVizcachas', false, 'CamaraVizcachas', 'Icono001.001');
});
eventHTMLElem('click', 'cam-titire', true, function(event) {
  setUserPosition('CamaraDireccionTitireBombeo', false, 'CamaraTitireBombeo', 'Icono001');
});
registerOnClick('ubi_presa_vizcachas', false, false, [0,1,2], function() {
  setUserPosition('cam_presa_vizcachas', 'operador-presa-vizcachas', 'ubi_presa_vizcachas', null);
}, function() {});
registerOnClick('ubi_rio_titire', false, false, [0,1,2], function() {
  setUserPosition('cam_titire', 'operador-titire', 'ubi_rio_titire', null);
}, function() {});
