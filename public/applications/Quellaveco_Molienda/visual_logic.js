...
eventHTMLElem('click', 'btn_empezar_recorrido', false, function(event) {
  setHTMLElemStyle('display', 'none', 'btn_empezar_recorrido', false);
  setHTMLElemStyle('display', 'flex', 'btn_mute_audio', false);
});
...
eventHTMLElem('click', 'btn_empezar_recorrido', false, function(event) {
  ...
  registerSetTimer('myTimer', 0.2, function() {
    ...
    registerSetTimer('myTimer2', 7, function() {
      /* 1000 */
      registerSetTimer('myTimer3', 1, function() {
        /* 2000 */
        outline('area_2600_poligon', 'ENABLE');
        console.log('2600');
        registerSetTimer('myTimer4', 1, function() {
          /* 3000 */
          outline('area_2600_poligon', 'DISABLE');
          outline('Area_sistema_de_recuperacion', 'ENABLE');
          console.log('area');
          registerSetTimer('myTimer5', 1, function() {
            /* 3300 */
...
registerOnHover('area_3400', false, function() {
  outline('area_3400', 'ENABLE');
}, function() {
  outline('area_3400', 'DISABLE');
});
registerOnClick('area_3400', false, false, [0,1,2], function() {
  if (sensor_activo == 4) {
    if (sena_3200 == false) {
      changeVis('laser_3400', true);
      outline('area_3400', 'ENABLE');

      operateAnimation('PLAY', 'laser_3400', 1, 60, 'LoopOnce', 5,
              function() {
        sensor_activo = 4;
        changeVis('area_3400_text', true);
        sena_in = false;
        sena_3200 = true;
        button_id = ['3400', '3500-3400'];
        setHTMLElemStyle('border', '1px solid rgb(10, 180, 255)', '3400', true);
        setHTMLElemStyle('border', '1px solid rgb(10, 180, 255)', '3500-3400', true);
      }, false);
...
registerOnHover('area_3700', false, function() {
  outline('area_3700', 'ENABLE');
}, function() {
  outline('area_3700', 'DISABLE');
});
registerOnClick('area_3700', false, false, [0,1,2], function() {
  if (sensor_activo == 7) {
    if (sena_3200 == false) {
      changeVis('laser_3700', true);
      outline('area_3700', 'ENABLE');

      operateAnimation('PLAY', 'laser_3700', 1, 60, 'LoopOnce', 5,
              function() {
        sensor_activo = 7;
        changeVis('Area_3700_text', true);
        sena_in = false;
        sena_3200 = true;
        button_id = ['3700', '3900-3700', '3500-3700'];
        setHTMLElemStyle('border', '1px solid rgb(10, 180, 255)', '3700', true);
        setHTMLElemStyle('border', '1px solid rgb(10, 180, 255)', '3900-3700', true);
        setHTMLElemStyle('border', '1px solid rgb(10, 180, 255)', '3500-3700', true);
      }, false);
...
registerOnHover('area_3600', false, function() {
  outline('area_3600', 'ENABLE');
}, function() {
  outline('area_3600', 'DISABLE');
});
registerOnClick('area_3600', false, false, [0,1,2], function() {
  if (sensor_activo == 6) {
    if (sena_3200 == false) {
      changeVis('laser_3600', true);
      outline('area_3600', 'ENABLE');

      operateAnimation('PLAY', 'laser_3600', 1, 60, 'LoopOnce', 5,
              function() {
        sensor_activo = 6;
        changeVis('Area_3600_text', true);
        sena_in = false;
        sena_3200 = true;
        button_id = '3600';
        setHTMLElemStyle('border', '1px solid rgb(10, 180, 255)', '3600', true);
      }, false);
