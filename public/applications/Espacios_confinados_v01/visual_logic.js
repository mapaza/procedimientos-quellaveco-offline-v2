...
var is_ft_loaded, is_multigas_clicked;
...
eventHTMLElem('click', 'btn_cerrar_informacion', false, function(event) {
  ...
  if (is_ft_loaded == true) {
    ...
    registerSetTimeout(6.25, function() {
...
eventHTMLElem('click', 'btn_next_2', false, function(event) {
  ...
  tweenCamera('camara_002', 'camara_direccion_002', 1, function() {
    ...
    if (is_multigas_clicked == true) {
      registerOnHover(['multigas', 'multigas_cuerda'], false, function() {
...
eventHTMLElem('click', 'btn_next_2_1', false, function(event) {
  ...
  tweenCamera('camara_003_1', 'camara_direccion_001', 2, function() {
    tweenCamera('camara_003_2', 'camara_direccion_003_2', 1, function() {
      tweenCamera('camara_003_3', 'camara_direccion_003_3', 1, function() {
        tweenCamera('camara_003_4', 'camara_direccion_003_4', 1, function() {
...
eventHTMLElem('click', 'btn_next_4', false, function(event) {
  ...
  tweenCamera('camara_005', 'camara_direccion_005', 1, function() {
    ...
    operateAnimation('SET_FRAME', 'canula_corto', 245, null, 'AUTO', 1,
            function() {}, false);


    operateAnimation('SET_FRAME', 'canula_largo', 252, null, 'AUTO', 1,
            function() {}, false);
...
eventHTMLElem('click', 'btn_next_9', false, function(event) {
  ...
  registerSetTimeout(5.25, function() {
    setHTMLElemStyle('display', 'flex', 'btn_next_final', false);
  });
  setHTMLElemStyle('display', 'none', 'btn_next_9', false);
  setHTMLElemStyle('display', 'none', 'nota_9', false);
  setHTMLElemStyle('display', 'flex', 'nota_final', false);
  setHTMLElemStyle('display', 'flex', 'nota_img_final', false);
  tweenCamera('camara_004', 'camara_direccion_004', 1, function() {}, 0);
});
eventHTMLElem('click', 'btn_next_final', false, function(event) {
  setHTMLElemStyle('display', 'none', 'btn_next_final', false);
  setHTMLElemStyle('display', 'none', 'nota_final', false);
...
operateAnimation('STOP', 'canula_largo', null, null, 'AUTO', 1,
        function() {}, false);


operateAnimation('STOP', 'canula_corto', null, null, 'AUTO', 1,
        function() {}, false);
